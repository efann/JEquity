...
public final class Misc
{
  ...
  // ---------------------------------------------------------------------------------------------------------------------
  // From https://stackoverflow.com/questions/5794227/how-to-check-if-class-exists-somewhere-in-package
  public static boolean isClassAvailable(final String tcClassName)
  {
    try
    {
      Class.forName(tcClassName);
      return (true);
    }
    catch (final ClassNotFoundException loErr)
    {
      return (false);
    }
  }
